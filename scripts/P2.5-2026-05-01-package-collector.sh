...
DIST_ROOT="$ROOT/dist"
PACKAGE="$DIST_ROOT/token-meter-collector"
...
rm -f "$PACKAGE/$SOURCE_JAR_NAME"
rm -f "$PACKAGE/$DIST_JAR_NAME"
rm -f "$PACKAGE/README.md"
rm -f "$PACKAGE/run-collector.sh"
rm -f "$PACKAGE/run-collector-service.sh"
rm -f "$PACKAGE/install-collector-service.sh"
rm -f "$PACKAGE/uninstall-collector-service.sh"
rm -f "$PACKAGE/P2.5-2026-05-01-run-collector.sh"
rm -f "$PACKAGE/P2.5-2026-05-01-run-collector-service.sh"
rm -f "$PACKAGE/P2.5-2026-05-01-install-collector-service.sh"
rm -f "$PACKAGE/P2.5-2026-05-01-uninstall-collector-service.sh"
...
This package uploads local Codex usage summaries to the team token-meter dashboard.
